...
In the following sections, we will take a look at different object detection approaches and how well they performed, to detect doors. The performance will be measured with the 
