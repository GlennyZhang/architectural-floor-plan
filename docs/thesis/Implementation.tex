...
1. Classifier -> Het wenig detektiert, defür fasch kei false positives
2. Classifier -> het viel z viel detektiert, defür fasch kei true positives
3. Classifier (line thickening) -> wengier detektiert, aber immerno viel z viel
3. Classifier thickening + PolyDP detection -> nid würkli besseri resultat bracht
4. Classifier -> Viel negativi -> besseri resultast
5. Classifier -> no meh negativi (chlineri bildli) -> super resultat
