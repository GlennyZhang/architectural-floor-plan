...
The prototype is able to load floor plans and run the predefined workflow. With the editing tool, the user is able to make enhancements between each step and can fix errors or mistakes on the plan.
